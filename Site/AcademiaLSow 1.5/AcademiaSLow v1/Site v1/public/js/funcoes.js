...
function validarSessao() {
    ...
    if (email != null && nome != null) {
        ...
        biotipo_user.innerHTML = biotipo;
        b_altura.innerHTML = altura;
        b_idade.innerHTML = idade;
        b_cor.innerHTML = cor;
        b_genero.innerHTML = genero;
